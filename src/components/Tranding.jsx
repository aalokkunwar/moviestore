...
const Tranding = () => {
  ...
  return (
    < >
     ...
     <div>
        <h2 className='flex text-red-800 text-xl md:text-3xl lg:text-4xl py-1 font-bold'>Trending Now... <FaFire/></h2>
      ...
      <div className=' relative overflow-hidden' >
        ...
        <img className=' group-hover:brightness-50 group-hover:scale-110 rounded-md' src={`https://image.tmdb.org/t/p/w500`+data.poster_path} alt={data.title} />
      ...
      <div className='py-1 '>
                  <h3 className='text-[10px] md:text-[13px] lg:text-[15px] font-bold hover:text-blue-900'> <marquee scrollamount="2">{(data.title || data.name)}</marquee> </h3>
